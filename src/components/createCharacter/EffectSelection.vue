...
<template>
    <div>
        ...
        <label v-for="{ idx, item } of effectIndex" :for="item.id" class="cursor-pointer block"
            :class="{ 'checkbox-disabled': shouldDisabled(item.id) }" :key="idx">
            <input type="checkbox" :id="item.id" :disabled="shouldDisabled(item.id)" :value="item.id"
        ...
        <div v-for="{ idx, item } of selectionIndex" :key="idx">
            <div class="flex items-start">
                ...
                <EffectSelection v-model="model.selectedSelection[idx]" :effect="item"
        ...
        <div v-for="{ idx, item } of groupIndex" :key="idx">
            <div class="flex items-start">
                ...
                <EffectGroup v-model="model.selectedGroup[idx]" :effects="item"
